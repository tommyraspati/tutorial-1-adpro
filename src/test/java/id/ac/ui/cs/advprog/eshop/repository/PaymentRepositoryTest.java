...
class PaymentRepositoryTest {
    ...
    void setUp() {
        ...
        Payment payment1 = new Payment("12345678-abcd-efgh-ijkl-1234567890ab", PaymentMethod.VOUCHER_CODE.getValue(), paymentData);
        payments.add(payment1);

        Payment payment2 = new Payment("87654321-abcd-efgh-ijkl-1234567890ab", PaymentMethod.BANK_TRANSFER.getValue(), paymentData);
