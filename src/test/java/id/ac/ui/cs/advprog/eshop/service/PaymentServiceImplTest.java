...
class PaymentServiceImplTest {
    ...
    void setUp() {
        ...
        Order order = new Order("12345678-abcd-efgh-ijkl-1234567890ab", products, 1708560000L, "Safira Sudrajat");
        orders.add(order);

        payments = new ArrayList<>();

        Map <String, String> paymentData1 = Map.of("voucherCode", "ESHOP1234ABC5678");
        Payment payment1 = new Payment("12345678-abcd-efgh-ijkl-1234567890ab", PaymentMethod.VOUCHER_CODE.getValue(), paymentData1);
        payments.add(payment1);

        Map <String, String> paymentData2 = Map.of("bankName", "BRI", "referenceCode", "1234567890");
        Payment payment2 = new Payment("12345678-abcd-efgh-ijkl-1234567890ab", PaymentMethod.BANK_TRANSFER.getValue(), paymentData2);
